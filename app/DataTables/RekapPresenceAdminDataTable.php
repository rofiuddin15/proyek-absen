...
use App\Models\RekapPresenceAdmin;
...
class RekapPresenceAdminDataTable extends DataTable
{
    /**
    ...
    {
        $model = Presence::with(['user_profile'])->orderBy('created_at', 'desc');
    ...
    {
        return $this->builder()
                    ->setTableId('rekappresenceadmin-table')
    ...
    {
        return 'RekapPresenceAdmin_' . date('YmdHis');
    }
}
